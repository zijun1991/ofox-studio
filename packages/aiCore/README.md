...
Ofox Claw AI Core 是一个基于 Vercel AI SDK 的统一 AI Provider 接口包，为 AI 应用提供强大的抽象层和插件化架构。
...
```bash
npm install @ofoxclaw/ai-core ai @ai-sdk/google @ai-sdk/openai
```
...
```typescript
import { AiCore } from '@ofoxclaw/ai-core'
...
```typescript
import { createOpenAIExecutor } from '@ofoxclaw/ai-core'
...
```typescript
import { registerProvider, AiCore } from '@ofoxclaw/ai-core'
...
```typescript
import { webSearchPlugin } from '@ofoxclaw/ai-core/built-in/plugins'
...
```typescript
import { createLoggingPlugin } from '@ofoxclaw/ai-core/built-in/plugins'
...
```typescript
import { createPromptToolUsePlugin } from '@ofoxclaw/ai-core/built-in/plugins'
...
```typescript
import { definePlugin } from '@ofoxclaw/ai-core'
...
```typescript
import { createClient } from '@ofoxclaw/ai-core'
...
更强大的是，你还可以将自定义注册表与 Ofox Claw 的插件系统结合使用：

```typescript
import { PluginEnabledAiClient } from '@ofoxclaw/ai-core'
import { createProviderRegistry } from 'ai'
import { createOpenAI } from '@ai-sdk/openai'
import { anthropic } from '@ai-sdk/anthropic'
...
- [Ofox Claw 项目](https://github.com/ofox/ofox-claw)
...
MIT License - 详见 [LICENSE](https://github.com/ofox/ofox-claw/blob/main/LICENSE) 文件

---

**Ofox Claw AI Core** - 让 AI 开发更简单、更强大、更灵活 🚀
